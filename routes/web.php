...
Route::group(['middleware' => ['role:revisor|admin', 'translate']], function () {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    Route::get('ver-informacion-ingresada-docente-revisor-fase-dos/{tipo}/{idpost}/{idansw}', [Competitions\PostulationsrevController::class, 'verinfingdocrevfasdos'])->name('ver.informacion.ingresada.docente.revisor.fase.dos');
    Route::get('ver-nuevo-formulario-revisor-segunda-etapa/{idpost}', [Competitions\PostulationsrevController::class, 'vernueforrevsegeta'])->name('ver.nuevo.formulario.revisor.segunda.etapa');
    Route::get('ver-nuevo-formulario-revisor-tercera-etapa/{idpost}', [Competitions\PostulationsrevController::class, 'vernueforrevtereta'])->name('ver.nuevo.formulario.revisor.tercera.etapa');
    Route::get('ver-nuevo-formulario-revisor-cuarta-etapa/{idpost}', [Competitions\PostulationsrevController::class, 'vernueforrevcuaeta'])->name('ver.nuevo.formulario.revisor.cuarta.etapa');

    Route::post('actualizar-observaciones-postulacion-revisor-fase-dos', [Competitions\PostulationsrevController::class, 'actobsposrevfasdos'])->name('actualizar.observaciones.postulacion.revisor.fase.dos');
