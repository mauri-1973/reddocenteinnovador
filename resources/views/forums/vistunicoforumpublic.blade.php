        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-success" href="{{route('acceder.forum.usuarios.activos.foro.publico', ['idcat' => Crypt::encrypt($idcat) ])}}" role="button">{{ trans('lang.volver')}}</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-8 mb-3 mb-sm-0">
                        <p class="text-sm">
                            ...
                            <span class="op-6 text-primary">{{ \Carbon\Carbon::parse($comment->created_at)->diffForHumans(null, true) }}</span> 
                        ...
                        <div class="text-sm op-5">
                           @foreach($tags as $t)
                           <span class="badge bg-success p-2 m-1 text-white">#{{ $t->nametag }}</span>
                           @endforeach
                        </div>
                    </div>
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="formaddsub" id="formaddsub" action="{{ route('busquedas.info.forums.publicos.usuario.registrado') }}" enctype="multipart/form-data" method="post">
                        @csrf
                        <input value="{{Crypt::encrypt($comment->idforthe)}}" id="idcat" name="idcat" type="hidden">
                        <input value="8" id="tipo" name="tipo" type="hidden">
                    ...
                    <div class="col-md-6 op-7">
                        <div class="row text-center op-7">
                            ...
                            <div class="col-5 px-1">
                                <form class="forma" id="forma" action="{{ route('busquedas.info.forums.publicos') }}" enctype="multipart/form-data" method="post">
                                @csrf
                                    <input value="{{Crypt::encrypt($comment->idforthe)}}" id="idforcom" name="idforcom" type="hidden">
                                    <input value="{{ Crypt::encrypt($resp[$row]['idresp']) }}" id="idresp" name="idresp" type="hidden">
                                    <input value="{{ Crypt::encrypt($idcat) }}" id="idcat" name="idcat" type="hidden">

                                    <input value="10" id="tipo" name="tipo" type="hidden">
                            ...
                            @endrole
                            <div class="col-5 px-1"> 
                                <form class="forma" id="forma" action="{{ route('busquedas.info.forums.publicos.usuario.registrado') }}" enctype="multipart/form-data" method="post" style="display:{{ $resp[$row]['display'] }}">
                                @csrf
                                    <input value="{{Crypt::encrypt($comment->idforthe)}}" id="idforcom" name="idforcom" type="hidden">
                                    <input value="{{ Crypt::encrypt($resp[$row]['idresp']) }}" id="idresp" name="idresp" type="hidden">
                                    <input value="{{ Crypt::encrypt($idcat) }}" id="idcat" name="idcat" type="hidden">

                                    <input value="9" id="tipo" name="tipo" type="hidden">
