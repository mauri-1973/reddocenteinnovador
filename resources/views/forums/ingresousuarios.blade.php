...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#dt-mant-table').DataTable({
                ...
                fixedHeader: true,
                ajax: {
                    url: "{{ route('acceder.forum.publico.usuarios.activos.ajax') }}",
                    data: function(d) {
                            ...
                            return `<div class="card row-hover pos-relative py-3 px-3 mb-3 border-warning border-top-0 border-right-0 border-bottom-0 rounded-0">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-12 mt-2">
                                            ...
                                            <a class="btn btn-success btn-sm float-right mr-1" href="{{ url('ver-contenido-tema-foro-publico-usuario-registrado' ) }}/${row.encrypt}" role="button" style="width:200px;" data-toggle="tooltip" data-placement="top" title="Haga click para ver el contenido completo del tema ingresado por el usuario" data-html="true">{{ trans('multi-leng.formerror70')}}</a>
