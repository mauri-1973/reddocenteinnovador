                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                        @if($finalstus->statusrub > 0)
                                            <a href="#" class="btn btn-primary btn-sm btn-block">{{ trans('inst.139') }}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                        @else
                                ...
                                <div class="row">
                                    ...
                                    <hr style="border-top: 2px solid #000;">
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg20" name="obspreg20" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg20 }}</textarea>
                                        ...
                                        <hr class="pt-3 mt-5" style="border-top: 2px solid #000;">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg21" name="obspreg21" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg21 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <hr class="pt-3 mt-5" style="border-top: 2px solid #000;">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg22" name="obspreg22" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg22 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <hr class="pt-3 mt-5" style="border-top: 2px solid #000;">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg23" name="obspreg23" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg23 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg24" name="obspreg24" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg24 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg25" name="obspreg25" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg25 }}</textarea>
                                            <span class="help-block">
