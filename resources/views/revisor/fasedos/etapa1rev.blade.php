                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg1" name="obspreg1" rows="15" maxlength="500">{{ $finalstus->obspreg1 }}</textarea>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg2" name="obspreg2" rows="15" maxlength="500">{{ $finalstus->obspreg2 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg3" name="obspreg3" rows="15" maxlength="500">{{ $finalstus->obspreg3 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg4" name="obspreg4" rows="15" maxlength="500">{{ $finalstus->obspreg4}}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg5" name="obspreg5" rows="15" maxlength="500">{{ $finalstus->obspreg5 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg6" name="obspreg6" rows="15" maxlength="500">{{ $finalstus->obspreg6 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg7" name="obspreg7" rows="15" maxlength="500">{{ $finalstus->obspreg7 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg8" name="obspreg8" rows="15" maxlength="500">{{ $finalstus->obspreg8 }}</textarea> 
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg9" name="obspreg9" rows="15" maxlength="500">{{ $finalstus->obspreg9 }}</textarea>
                                            <span class="help-block">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#obspreg1').trigger('keyup');
        $('#obspreg2').trigger('keyup');
        $('#obspreg3').trigger('keyup');
        $('#obspreg4').trigger('keyup');
        $('#obspreg5').trigger('keyup');
        $('#obspreg6').trigger('keyup');
        $('#obspreg7').trigger('keyup');
        $('#obspreg8').trigger('keyup');
        $('#obspreg9').trigger('keyup');
    });
    $('#obspreg1').keyup(function () {
        var max = 500;
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg1", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg2').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg2", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg3').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg3", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg4').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg4", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg5').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg5", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg6').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg6", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg7').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg7", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg8').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {
        ...
        else 
        {
            ...
            actualizardatos($(this).val(), "obspreg8", "correctionsprocesodos", "actualizar");

        }
    });
    $('#obspreg9').keyup(function () {
        var max = 500;
        var len = $(this).val().length;
        if (len >= max) 
        {

            $('#mensaje_ayuda9').text('{{ trans('multi-leng.a59')}}');// Aquí enviamos el mensaje a mostrar          
            $('#mensaje_ayuda9').addClass('text-danger'); 
        ...
        else 
        {
            ...
            var ch = max - len;
            $('#mensaje_ayuda9').text(ch + '{{ trans('multi-leng.a58')}}');
            $('#mensaje_ayuda9').removeClass('text-danger');
            actualizardatos($(this).val(), "obspreg9", "correctionsprocesodos", "actualizar");
