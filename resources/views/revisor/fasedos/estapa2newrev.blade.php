                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="author text-white mb-3">
                                            <h5 class="text-dark">{{ __('inst.148') }} </h5>
                                        </div>
                                        <hr style="border-top: 2px solid #000;">
                                            <div class="form-group mb-4">
                                                <label for="preg1a" class="textlabel text-dark"><b>{{ __('inst.149') }}</b>&nbsp;&nbsp;<i style="color:#fff;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('multi-leng.a95') }}" data-html="true"></i>&nbsp; <small style="color:white;font-size:10px;">(* {{ __('lang.infoobli') }})</small></label>
                                                ...
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg10" name="obspreg10" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg10 }}</textarea>
                                        ...
                                        <hr style="border-top: 2px solid #000;">
                                            <div class="form-group mb-4">
                                                <label for="preg2a" class="textlabel text-dark"><b>{{ __('inst.150') }}</b>&nbsp;&nbsp;<i style="color:#fff;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('multi-leng.a97') }}" data-html="true"></i>&nbsp; <small style="color:white;font-size:10px;">(* {{ __('lang.infoobli') }})</small></label>
                                                ...
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg11" name="obspreg11" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg11 }}</textarea>
                                                <span class="help-block">
                                                    <p id="mensaje_ayuda11" class="help-block"></p>
                                                </span>
                                                <hr style="border-top: 2px solid #000;">
                                                <table class="table table-bordered table-sm" style="background-color:#fff;" id="tabla2">
                                                    <caption class="bg-success p-2 text-white">{{ trans('inst.107')}} &nbsp;
                                                    </caption>
                                                    <thead>
                                                        <tr>
                                        ...
                                        <hr style="border-top: 2px solid #000;">
                                            <div class="form-group mb-4">
                                                <label for="preg3a" class="textlabel text-dark"><b>{{ __('inst.151') }}</b>&nbsp;&nbsp;<i style="color:#fff;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('multi-leng.a99') }}" data-html="true"></i>&nbsp; <small style="color:white;font-size:10px;">(* {{ __('lang.infoobli') }})</small></label>
                                                ...
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg12" name="obspreg12" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg12 }}</textarea>
                                                <span class="help-block">
                                        ...
                                        <hr style="border-top: 2px solid #000;">
                                            <div class="author text-white mb-3">
                                                <br>
                                                <h5 class="text-dark">{{ __('inst.152') }} </h5>
                                                <br>
                                            </div>
                                        <hr style="border-top: 2px solid #000;">
                                            <div class="form-group mb-4">
                                                <label for="preg4a" class="textlabel text-dark"><b>{{ __('inst.153') }}</b>&nbsp;&nbsp;<i style="color:#fff;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('multi-leng.a101') }}" data-html="true"></i>&nbsp; <small style="color:white;font-size:10px;">(* {{ __('lang.infoobli') }})</small></label>
                                                ...
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg13" name="obspreg13" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg13 }}</textarea>
                                                <span class="help-block">
                                        ...
                                        <hr style="border-top: 2px solid #000;">
                                            <div class="form-group mb-4">
                                                <label for="preg5a" class="textlabel text-dark"><b>{{ __('inst.154') }}</b>&nbsp;&nbsp;<i style="color:#fff;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('multi-leng.a103') }}" data-html="true"></i>&nbsp; <small style="color:white;font-size:10px;">(* {{ __('lang.infoobli') }})</small></label>
                                                ...
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obspreg14" name="obspreg14" rows="15" maxlength="500" disabled>{{ $finalstus->obspreg14 }}</textarea>
                                                <span class="help-block">
