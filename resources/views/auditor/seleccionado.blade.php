                            ...
                            <div class="content">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-white">
                                        @role('admin')
                                            <a href="{{ route('ver-postulaciones-concursos-registrados-administrador' , $idconcurso) }}" class="btn btn-warning btn-sm btn-block" style="display:{{ $display }}">{{ trans('lang.volver')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                    ...
                                    @role('admin')
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-white">
                                        <a href="{{ route('ver-actas-concurso-seleccionado', Crypt::encrypt($answ[0]->idansw)) }}" role="button" class="btn btn-warning btn-sm btn-block">{{ trans('multi-new.0136')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-white">
                                        <a href="{{ route('ver-presupuesto-formulario-administrador-concurso-seleccionado', Crypt::encrypt($answ[0]->idansw)) }}" role="button" class="btn btn-warning btn-sm btn-block">{{ trans('multi-new.0207')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                    </div>
                                        ...
                                        <div class="form-group mb-4">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    @role('admin')
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <a href="{{ route('ver-postulaciones-concursos-registrados-administrador' , $idconcurso) }}" class="btn btn-warning btn-sm btn-block">{{ trans('lang.volver')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                    </div>
                                                    @endrole
                                                    @role('auditor')
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
