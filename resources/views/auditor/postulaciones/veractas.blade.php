    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="row justify-content-center mt-4">
                @if($statusacta == "crearacta")
                <div class="col-md-12">
                    <div class="card mb-4 bg-success shadow-sm text-white">
                        <div class="card-body">
                            <h3><strong>{{ trans('multi-new.0280')}} </strong></h3><br><br>
                            @if(Auth::user()->hasRole('auditor')  )
                            <a href="{{ route('ver-asignaciones-auditor-id-postulacion', $idconc) }}" class="btn btn-info btn-sm">{{ trans('lang.volver')}}</a>
                            <button class="btn btn-warning btn-sm" onclick="solicitaractas('{{ $idansw }}', 'crearacta', '{{ Crypt::encrypt(Auth::user()->id) }}', '')">{{ trans('multi-new.0278')}}</button>
                            @endif 
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4 bg-success shadow-sm text-white">
                        <div class="card-body">
                            <h3><strong>{{ trans('multi-new.0285')}} </strong></h3><br><br>
                            @if(Auth::user()->hasRole('auditor')  )
                            <a href="{{ route('ver-asignaciones-auditor-id-postulacion', $idconc) }}" class="btn btn-info btn-sm">{{ trans('lang.volver')}}</a>
                            <button class="btn btn-warning btn-sm" onclick="solicitaractas('{{ $idansw }}', 'creada', '{{ Crypt::encrypt(Auth::user()->id) }}', '')">{{ trans('multi-new.0278')}}</button>
                            @endif 
                        </div>
                        
                    </div>
                </div>
                @elseif($statusacta == "encurso" || $statusacta == "finalizada" || $statusacta == "cerrada")
                <div class="col-md-12">
                    <div class="card mb-4 bg-success shadow-sm text-white">
                        <div class="card-body">
                            <div class="content-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="collapse col-12" id="info">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <a href="{{ route('imprimr-formulario-auditor', Crypt::encrypt($defansw->idansw) ) }}" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0067') }}">{{ trans('multi-new.0062')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></a>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <button  class="btn btn-warning btn-sm btn-block" id="imprimiracta" onclick="solicitaractas('{{ Crypt::encrypt($actas->id) }}', 'imprimir', '{{ Crypt::encrypt(Auth::user()->id) }}', '')" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0286') }}">{{ trans('multi-new.0157')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i>
                                                </button>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <button type="button" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0068') }}" onclick="solicitaractas('{{ Crypt::encrypt($actas->id) }}', 'emailteacher', '{{ Crypt::encrypt($defansw->id) }}')">{{ trans('multi-new.0063')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></button>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <button type="button" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0069') }}" onclick="solicitaractas('{{ Crypt::encrypt($actas->id) }}', 'notificaciones', '{{ Crypt::encrypt($defansw->id) }}')">{{ trans('multi-new.0064')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:" ></i></button>
                                            </div>
                                        </div>        
                                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseOne" class="panel-collapse collapse mb-3" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                ...
                                                <div class="col-12 border border-white pt-2 pb-2">
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            {{ trans('multi-new.0095')}}: {{ $row->name.' '.$row->surname }}
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                Email: {{ $row->email }}
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                            {{ trans('multi-new.0094')}}: {{ $row->mobile }}
                                                            </div>
                                                        </div>
                                                        @if(count($actasadit) > 1)
                                                ...
                                                <br>
                                                <h3><strong>{{ trans('multi-new.0098')}}: {{ $avanceaux }}% </strong></h3>
                                                <div class="col-12 border border-white pt-2 pb-2">
                                                    <div class="container-fluid">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="progress mt-2 mb-2">
                                                                    <div class="progress-bar w-{{ $avanceaux }} bg-info" role="progressbar" id="progressbarglobal"  aria-valuenow="{{ $avanceaux }}" aria-valuemin="0" aria-valuemax="100">{{ $avanceaux }}%</div> 
                    ...
                    <div class="card mb-4 bg-success shadow-sm text-white">
                                    ...
                                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                                        <div class="col-12 mt-5">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 mt-2 mb-2">
                                                    <div class="progress mt-3 mb-3">
                                                        <div class="progress-bar w-{{ round($personal->porcentaje, 0, PHP_ROUND_HALF_UP) }} bg-info" id="progressgen" name="progressgen" role="progressbar" aria-valuenow="{{ round($personal->porcentaje, 0, PHP_ROUND_HALF_UP) }}" aria-valuemin="0" aria-valuemax="100">
                                                            {{ round($personal->porcentaje, 0, PHP_ROUND_HALF_UP) }}%
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 mt-2 mb-2">
                                                    <input type="number" class="form-control input-lg" id="porcentajeaud" name="porcentajeaud" min="0" max="100" value="{{ $personal->porcentaje }}" onkeypress="return valideKey(event);" {{ $disabled }}/> 
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="porcentajeaud" class="col-4 col-lg-4 col-md-4 col-sm-12 col-xs-12 col-form-label text-white mt-2 mb-2">
                                                    <i style="color:#fff;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0287')}}"></i>
                                                </label>
                                                <div class="col-8 col-lg-8 col-md-8 col-sm-12 col-xs-12 mt-2 mb-2">
                                                    <form action="{{ route('funcionalidades-ajax-usuario-auditor') }}" method="post" class="mt-1" id="formact" name="formact">
                                                        @csrf 
                                                        <input type="hidden" name="idansw" id="idansw" value="{{ $idansw }}">
                                                        <input type="hidden" name="porcentajeact" id="porcentajeact" value="{{ $personal->porcentaje }}">
                                                        <input type="hidden" name="tipo" id="tipo" value="actualizarporcentaje">
                                                        <input type="hidden" name="idacta" id="idacta" value="{{ Crypt::encrypt($personal->id) }}">
                                                        
                                                        <button type="submit" id="actualizarporcetaje" class="btn btn-warning btn-sm btn-block" {{ $disabled }}>{{ trans('multi-new.0143')}}</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="card-footer">
                                ...
                                <div class="form-group">
                                    ...
                                    <button  class="btn btn-info btn-sm" id="agendarreunion" onclick="solicitaractas('{{ Crypt::encrypt($arreglo->id) }}', 'agendarreunion', '{{ Crypt::encrypt(Auth::user()->id) }}', '{{ $personal->id }}')" disabled>{{ trans('multi-new.0155')}}</button>
                                    <form action="{{ route('funcionalidades-ajax-usuario-docente-actas') }}" method="post" class="mt-1" disabled>
                                        @csrf 
                                        <input type="hidden" name="idansw" id="idansw" value="{{ $idansw }}">
                                        ...
                                        <button type="submit" id="finalizaracta" class="btn btn-warning btn-sm" disabled>{{ trans('multi-new.0154')}}</button>
                                    </form>
                                </div>
                        </div> 
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#progressgen').html("{{ $personal->porcentaje }}%");
        $('#progressgen').width("{{ $personal->porcentaje }}%").attr('aria-valuenow', {{ $personal->porcentaje }});
        $('#progressbarglobal').html("{{ $avanceaux }}%");
        $('#progressbarglobal').width("{{ $avanceaux }}%").attr('aria-valuenow', {{ $avanceaux }});
    ...
    $("#formact").submit(function(event)
        {
            ...
            var input = $("#porcentajeaud").val().trim();
            
            if (input === "") 
            {
                error += "{{ trans('multi-new.0288')}}"+'<br>';
            ...
            {
                $("#porcentajeact").val($("#porcentajeaud").val().trim());
                this.submit();
            }
        }
    );
    ...
    function solicitaractas(valida, tipo, validu, adic)
    {
        switch (true) {
            ...
            case (tipo == 'respuestaemail'):
                ...
                var text = "Sin-Respuestas";
                if(adic != "")
                {
                    
                    text = adic.replaceAll("---*", "\n");
                    text = adic.replaceAll("<br>", "\n");
            ...
            break;
            case (tipo == 'crearacta' || tipo == 'creada'):
    ...
    function ajax(form, tipo)
    {
        ...
        $.ajax({
            ...
            success: function(respu)
            {
                ...
                else if( respu.status == "ok" && tipo === "crearacta" )
                {
                    $('#staticBackdrop').modal('hide');
                    notificacion(respu.html, "success", "{{ trans('multi-new.0133')}}");
                    
                }
                else if( respu.status == "error" && tipo === "crearacta" )
                {
                    $('#staticBackdrop').modal('hide');
                    notificacion(respu.html, "danger", "{{ trans('multi-new.0135')}}");
                    
                }
                else if( respu.status == "ok" && tipo === "creada" )
                {
                    $('#staticBackdrop').modal('hide');
                    notificacion(respu.html, "success", "{{ trans('multi-new.0133')}}");
                    
                }
                else if( respu.status == "error" && tipo === "creada" )
                {
                    $('#staticBackdrop').modal('hide');
                    notificacion(respu.html, "danger", "{{ trans('multi-new.0135')}}");
                ...
                else if( respu.status == "ok" && tipo === "notificaciones" )
                {
                        ...
                        Object.keys(obj).forEach(key => {
                            ...
                            html += `<tr>
                                            ...
                                            <tr>
                                                ...
                                                <th scope="col" class="text-left"><button class="btn btn-primary" id="mensaje" onclick="solicitaractas('${obj[key].mensaje}', 'respuestaemail',  '${obj[key].id}', '${text1}')">{{ trans('multi-new.0199')}}</button></th>
                                            </tr>`;
                        });
                    }
                    ...
                    $('#modalbody').html(`<div class='col-12 table-responsive'>
                                        <table id="dt-mant-table-modal" class="table table-bordered table-hober  display responsive" style="width:100%;">
                                           <tbody>
                                            ${html}                                         
                                            </tbody>
                                        </table></div>`);
