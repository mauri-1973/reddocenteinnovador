                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p style="text-align: center; color:#000;padding-top:30px;">
                                            ...
                                            <a target="_blank" style="background-color: #009FD4;color: white;" href="{{url('/')}}" class="btn">Presione el link para continuar</a>
