                            ...
                            <table role="presentation"
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        {{ __('multi-new.0110') }} {{ $user ? $user['fechaini'] : '' }} {{ __('multi-new.0111') }} {{ $user ? $user['fechafin'] : '' }} {{ __('multi-new.0112') }}
                                        ...
                                        {{ __('multi-new.0114') }} {{ $user ? $user['academico'] : '' }}

                                        </p>
                                        <p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">

                                        {{ __('multi-new.0115') }} {{ $user ? $user['emailacad'] : '' }}

                                        </p>
                                        <p style="margin:0 0 12px 0;font-size:14px;line-height:24px;font-family:Arial,sans-serif;">

                                        {{ __('multi-new.0116') }} {{ $user ? $user['telacad'] : '' }}
