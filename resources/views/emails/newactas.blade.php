                                ...
                                <tr>
                                    ...
                                    <td style="padding:0 0 36px 0;color:#153643;">
                                        ...
                                        <p
                                            ...
                                            Le informamos que ya puede generar el acta inicial, respecto a su proyecto ({{ $user ? $user['title'] : '' }}). Ingrese a nuestra plataforma, para generar el cronográma general de las actas de revisión de su proyecto, para seguir la trazabilidad del mismo.
