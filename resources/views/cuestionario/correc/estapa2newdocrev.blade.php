                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="author text-white mb-3">
                                            <h5 class="text-dark">{{ trans('inst.103') }}</h5>
                                        </div>
                                        <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <label for="preg1a" class="textlabel text-dark"><b>{{ trans('inst.104') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ trans('inst.105') }}" id="preg1a" name="preg1a" rows="30" disabled>{{ $finalstus->pregunta1 }}</textarea>
                                                <span class="help-block">
                                                    <p id="mensaje_ayuda1" class="help-block" style="color:#000;"></p>
                                                </span>
                                                <label for="obs1" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg10 }}</textarea> 
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <label for="preg2a" class="textlabel text-dark"><b>{{ trans('inst.106') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ trans('inst.105') }}" id="preg2a" name="preg2a" rows="30" disabled>{{ $finalstus->pregunta2 }}</textarea>
                                                <span class="help-block">
                                                ...
                                                <table class="table table-bordered table-sm" style="background-color:#fff;" id="tabla2">
                                                    <caption class="bg-primary text-white pl-2">{{ trans('inst.107') }} &nbsp;
                                                    </caption>
                                                    <thead>
                                                        <tr>
                                                ...
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs2" name="obs2" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg11 }}</textarea> 
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <label for="preg3a" class="textlabel text-dark"><b>{{ trans('inst.108') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ trans('inst.105') }}" id="preg3a" id="preg3a" rows="30" disabled>{{ $finalstus->pregunta3 }}</textarea>
                                                <span class="help-block">
                                                    <p id="mensaje_ayuda3" class="help-block" style="color:#000;"></p>
                                                </span>
                                                <label for="obs3" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs3" name="obs3" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg12 }}</textarea> 
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="author text-white mb-3">
                                                <br>
                                                <h5 class="text-dark">{{ trans('inst.111') }}</h5>
                                                <br>
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <label for="preg4a" class="textlabel text-dark"><b>{{ trans('inst.109') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ trans('inst.105') }}" id="preg4a" name="preg4a" rows="30" disabled>{{ $finalstus->pregunta4 }}</textarea>
                                                <span class="help-block">
                                                    <p id="mensaje_ayuda4" class="help-block" style="color:#000;"></p>
                                                </span>
                                                <label for="obs4" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs4" name="obs4" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg13 }}</textarea> 
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <label for="preg5a" class="textlabel text-dark"><b>{{ trans('inst.110') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ trans('inst.105') }}" id="preg5a" id="preg5a" rows="30" disabled>{{ $finalstus->pregunta5 }}</textarea>
                                                <span class="help-block">
                                                    <p id="mensaje_ayuda5" class="help-block" style="color:#000;"></p>
                                                </span>
                                                <label for="obs5" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                                <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs5" name="obs5" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg14 }}</textarea> 
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <a href="{{ route('ver.informacion.ingresada.docente.fase.dos', ['tipo' => $poststatus, 'idpost' => $idpost, 'idansw' => Crypt::encrypt($finalstus->id) ] )  }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a104')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <a href="{{ route('ver-postulaciones-concursos-registrados-administrador', Crypt::encrypt($finalstus->idconc) ) }}" class="btn btn-warning btn-sm btn-block">{{ trans('multi-leng.lognav')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <a href="{{ route('ver.nuevo.formulario.docente.tercera.etapa.admin', $idpostulacion ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a88')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
