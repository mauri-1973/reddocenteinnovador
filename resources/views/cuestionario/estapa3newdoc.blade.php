                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-white">
                                        <h4 class="text-dark">{{ trans('multi-leng.a199') }} <strong class="statusval">{{ ($status == 1) ? trans('multi-leng.a197') : trans('multi-leng.a198') }}</strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="Ingrese los indicadores y métodos de monitoreo" id="indicadores" name="indicadores" rows="30" >{{ $finalstus->pregunta6 }}</textarea>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="Ingrese los resultados y productos esperados" id="resultados" name="resultados" rows="30" >{{ $finalstus->pregunta7 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="Ingrese los indicadores de impacto" id="impacto" name="impacto" rows="30" >{{ $finalstus->pregunta8 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="Ingrese los indicadores de impacto institucional" id="institucional" name="institucional" rows="30" >{{ $finalstus->pregunta9 }}</textarea>
                                            <span class="help-block">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <button type="button" class="btn btn-success btn-sm" onclick="agregarhito('agregar', '', '', '', '', '');">Agregar Hito</button>
                                            <table class="table table-bordered table-sm" style="background-color:#fff;" id="tabla2">
                                                ...
                                                <tbody id="tbodytable2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                        <button type="button" class="btn btn-warning btn-sm btn-block mb-1" onclick='agregarhito("editar", "{{ Crypt::encrypt($row->id) }}", "{{ $row->titulo }}", "{{ $row->fechainicio }}", "{{ $row->fechatermino }}", "{{ str_replace(PHP_EOL, ' ', $row->descripcion )}}");'>Editar Hito</button>
                                                        <button type="button" class="btn btn-danger btn-sm" onclick='agregarhito("eliminar", "{{ Crypt::encrypt($row->id) }}", "{{ $row->titulo }}", "{{ $row->fechainicio }}", "{{ $row->fechatermino }}", "{{ str_replace(PHP_EOL, ' ', $row->descripcion )}}");'>Eliminar Hito</button>
                                                        </th>
                                                    </tr>
                                                    @endforeach
                                                </tbody>
                                            ...
                                            <div class="container-fluid">
                                                <div class="row">
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <a href="{{ route('ver.nuevo.formulario.docente.segunda.etapa', $idpostulacion)  }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a104')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                        </div>
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            <a href="{{ route('ver.nuevo.formulario.docente.cuarta.etapa', $idpostulacion)  }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a88')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                        </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-dark">
                                        <h4>{{ trans('multi-leng.a199') }} <strong class="statusval">{{ ($status == 1) ? trans('multi-leng.a197') : trans('multi-leng.a198') }}</strong></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
