        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="">
                    ...
                    {{ __('lang.addnewuser') }} ({{ trans('multi-leng.multi4')}})
                ...
                <div class="card-body">
                    ...
                    <form id="form_validation" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <label class="form-label"><b>{{ trans('multi-leng.multi2')}}</b>&nbsp;&nbsp;<i style="color:#004238;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('multi-leng.formerror14') }}" data-html="true"></i>&nbsp; <small style="color:red;font-size:8px;">(* {{ __('lang.infoobli') }})</small></label>
                            ...
                            <select class="form-control @error('subcat') is-invalid @enderror" data-btn-class="btn-success btn-block" id="subcat" name="subcat[]" multiple data-live-search="true" data-live-search-placeholder="{{ __('multi-leng.formerror12') }}">
                                ...
                                @foreach($val as $p => $slice)

                                    <optgroup label="Docente : {{ $p }}">

                                        @foreach($val[$p] as $q)

                                        <option value="{{ $q['idrec'] }}">{{ $q['namecat'] }}--{{ $q['namesub'] }}</option>
    ...
    $( "#form_validation" ).submit(function( event ) 

        {
...

            {
                ...
                error += "-. Debe asignar al menos un docente al estudiante.<br>";
...

            {
                    ...
                    $.notify({
                        ...
                        message: 'Para agregar un nuevo usuario, correspondiete al perfil estudiante; debe solucionar los siguientes errores:<br>'+
