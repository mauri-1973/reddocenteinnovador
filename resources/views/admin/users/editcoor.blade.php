                    ...
                    <div class="card">
                        ...
                        <div class="body">
                           <form id="form_validation" method="POST" action="{{ route('users.update',Crypt::encrypt($user->id)) }}" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="tipo" id="tipo" value="coordinador">
                            @else
                            ...
                            @endif
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="form-label" for="comp"><b>{{ __('inst.176') }}</b>&nbsp;&nbsp;<i style="color:#004238;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('inst.175') }}" data-html="true"></i>&nbsp; <small style="color:red;font-size:8px;">(* {{ __('lang.infoobli') }})</small></label>

                                    <select class="form-control" name="comp[]" id="comp" multiple  required>

                                        @foreach($comp as $co)

                                            <option value="{{ $co['idcomp'] }}" {{ $co['selected'] }}>{{ $co['title'] }}</option>
