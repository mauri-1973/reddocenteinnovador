        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="">
                    ...
                    <h3>{{ trans('multi-leng.userdetal')}} ({{ trans('multi-leng.multi3')}})</h3>

                    <a href="{{ route('mostrar-formulario-tipo-usuario', ['tipo' => 'periodistas']) }}" class="btn btn-success btn-sm">{{ trans('multi-leng.addnewuser')}}</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form id="delete_form{{$row->id}}" method="POST" action="{{ route('users.destroy',$row->id) }}" onclick="return confirm('{{ trans("multi-leng.areyousur")}}')">
                                        ...
                                        <input name="tipo" type="hidden" value="not">
