        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="">
                    ...
                    {{ __('lang.addnewuser') }} ({{ trans('inst.172')}})
                ...
                <div class="card-body">
                    ...
                    <form id="form_validation" method="POST" action="{{ route('users.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{old('email')}}" placeholder="{{ __('lang.email1') }}" maxlength="100" onfocus="this.value=''" autofocus required>
                        ...
                        <div class="form-group" style="display:none;">
                            ...
                            <select class="form-control" name="roles[]" id="roles" autofocus required>
                                ...
                                @foreach($roles as $role)
                                    ...
                                    <option value="{{ $role }}" selected>{{ __('multi-new.0047') }}</option>
                        ...
                        <div class="form-group">
                            ...
                            <label class="form-label" for="comp"><b>{{ __('inst.173') }}</b>&nbsp;&nbsp;<i style="color:#004238;font-size:18px;" class="fa fa-info-circle" aria-hidden="true" data-toggle="tooltip" data-placement="top" title="{{ __('inst.175') }}" data-html="true"></i>&nbsp; <small style="color:red;font-size:8px;">(* {{ __('lang.infoobli') }})</small></label>

                            <select class="form-control" name="comp" id="comp"  required>

                                <option value="0" selected>{{ __('inst.173') }}</option>

                                @foreach($comp as $co)

                                    <option value="{{ $co->idcomp }}">{{ $co->title }}</option>
                                ...
                                <label id="comp-error" class="error" for="comp">{{ $message }}</label>
...
<script type="text/javascript">
    ...
    var foption2 = $('#comp option:first');

    var soptions2 = $('#comp option:not(:first)').sort(function (a, b) {

        return a.text == b.text ? 0 : a.text < b.text ? -1 : 1

    });

    $('#comp').html(soptions2).prepend(foption2);
    ...
    $( "#form_validation" ).submit(function( event ) 

        {
...

            {
                ...
                $( "#comp" ).val(escapeHtml($( "#password" ).val()));
