                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <a role="button" href="{{ route('ver-informacion-ingresada-docente', ['tipo' => 'historial', 'idpost' => $id, 'idansw' => Crypt::encrypt($idansw) ] ) }}" role="button" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0103') }}">{{ trans('lang.volver')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <a role="button" href="{{ route('imprimr-formulario-administrador-presupuesto-concurso-seleccionado', Crypt::encrypt($id) ) }}" class="btn btn-warning btn-sm btn-block">{{ trans('multi-new.0264')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></a>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <button type="button" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0279') }}" onclick="solicitaractas('{{ Crypt::encrypt($answ->idansw) }}', 'emailteacher', '{{ Crypt::encrypt(Auth::user()->id) }}', '')">{{ trans('multi-new.0278')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></button>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
...
<script type="text/javascript">
    ...
    function ajax(form, tipo)
    {
        ...
        $.ajax({
            type: "POST",
            url: '{{url("/")}}/funcionalidades-ajax-usuario-administrador-presupuestos',
            data: form,
            processData: false,
            contentType: false,
            dataType: "JSON",
            success: function(respu)
            {
                ...
                {
                    $('#staticBackdroptwo').modal('hide');
                    notificacion("{{ trans('multi-new.0231')}}", "success", "{{ trans('multi-new.0125')}}");
