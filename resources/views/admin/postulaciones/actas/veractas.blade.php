    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="row justify-content-center mt-4">
                ...
                1
                @elseif($statusacta == "sinhistorial")
                        ...
                        <div class="col-md-12">
                            <div class="card mb-4 bg-success shadow-sm text-white">
                                <div class="card-body">
                                                ...
                                                <div class="col-12 border border-white pt-2 pb-2">
                                                    <div class="container-fluid">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            {{ trans('multi-new.0093')}}: {{ $row->name }} {{ $row->surname }}
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                Email: {{ $row->email }}
                                                            </div>
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            {{ trans('multi-new.0275')}}:
                                                            @if($row->status == 'si')
                                                            {{ trans('multi-new.0276')}}
                                                            @endif
                                                            @if($row->status == 'no')
                                                            {{ trans('multi-new.0277')}}
                                                            @endif
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <a href="{{ route('ver-informacion-ingresada-docente', ['tipo' => 'historial', 'idpost' => $id, 'idansw' => $idansw ]) }}" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0065') }}">{{ trans('lang.volver')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></a>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="collapse" id="info">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <a href="{{ route('imprimr-formulario-revisor', Crypt::encrypt($id) ) }}" class="btn btn-info btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0067') }}">{{ trans('multi-new.0062')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></a>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                <button type="button" class="btn btn-warning btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0068') }}" onclick="solicitaractas('{{ Crypt::encrypt($arreglo->id) }}', 'emailteacher', '{{ Crypt::encrypt(Auth::user()->id) }}', '')">{{ trans('multi-new.0063')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></button>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="card mb-4 bg-success shadow-sm text-white">
                                ...
                                <div class="card-footer">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="{{ route('ver-informacion-ingresada-docente', ['tipo' => 'historial', 'idpost' => $id, 'idansw' => $idansw ]) }}" class="btn btn-info btn-sm">{{ trans('lang.volver')}}</a>
                ...
                @elseif($statusacta == "conhistorial")
                3
                @else
                    error
                @endif
...
<script type="text/javascript">
    ...
    function ajax(form, tipo)
    {
        ...
        $.ajax({
            type: "POST",
            url: '{{url("/")}}/funcionalidades-ajax-usuario-administrador-actas',
            data: form,
            processData: false,
            contentType: false,
            dataType: "JSON",
            success: function(respu)
            {
                ...
                {
                    $('#staticBackdrop').modal('hide');
                    notificacion("{{ trans('multi-new.0169')}}", "success", "{{ trans('multi-new.0131')}}");
