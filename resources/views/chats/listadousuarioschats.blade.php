        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="card">
                ...
                <div class="">
                        ...
                        @endif
                    <a href="{{url('/')}}/buscar-chats-usuario-registrado" class="btn btn-success btn-sm" role="button">{{ trans('lang.volver')}}</a>
                    ...
                    <table id="dt-mant-table" class="table table-bordered display responsive nowrap" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if($tipo == 0)
                                <td>
                                    <a href="{{url('/')}}/acciones-usuarios-docentes-chats/2/{{ Crypt::encrypt($array[$row]['idforpar'] )}}" class="btn btn-danger btn-sm btn-block mt-1" role="button">{{ trans('multi-leng.formerror186')}}</a>
                                </td>
                                @endif
                                @if($tipo == 1)
                                <td>
                                    <a href="{{url('/')}}/acciones-usuarios-docentes-chats/1/{{ Crypt::encrypt($array[$row]['idforpar'] )}}" class="btn btn-success btn-sm btn-block mt-1" role="button">{{ trans('multi-leng.formerror185')}}</a>
                                    <a href="{{url('/')}}/acciones-usuarios-docentes-chats/2/{{ Crypt::encrypt($array[$row]['idforpar'] )}}" class="btn btn-danger btn-sm btn-block mt-1" role="button">{{ trans('multi-leng.formerror186')}}</a>
                                </td>
