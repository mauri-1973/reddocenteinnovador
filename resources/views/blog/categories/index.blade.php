...
<div class="content">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                <div class="">
                    <h3>{{ trans('multi-leng.formerror21')}}</h3>
                    <button onclick="addcat();" class="btn btn-success btn-sm">{{ trans('multi-leng.formerror23')}}</button>
                </div>
                <div class="card-body">
                    <table id="dt-mant-table" class="table table-bordered display responsive nowrap" style="width:100%">
                        ...
                        @foreach($categories as $category)
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-success btn-sm btn-block editcat mb-1" data-id='{{ $category->id }}' data-nombre='{{ $category->title }}'>{{ trans('multi-leng.editarcateg')}}</button>
                                    <button type="button" class="btn btn-danger btn-sm btn-block delcat" data-id='{{ $category->id }}' data-nombre='{{ $category->title  }}'>{{ trans('multi-leng.eliminarcateg')}}</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
...
<script type="text/javascript">
    ...
    function validarnombre(nombre)
    {
        ...
        $.ajax({
            url: '{{route("validar-nombre-categoria-blog")}}',
            type: 'POST',
            async: false,
            dataType: 'json',
            data: {name: nombre},
