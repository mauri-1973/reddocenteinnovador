    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form  id="formpost" method="post" action="{{ route('agregar-publicaciones-blog')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary">{{ trans('lang.enviar')}}</button>
