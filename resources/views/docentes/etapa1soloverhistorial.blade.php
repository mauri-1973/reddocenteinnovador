                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-white">
                                        ...
                                        @if($tipo != "inicial" &&  $tipo != "enrevision" && $tipo != "conobservaciones" && $tipo != "historial" && Auth::user()->id != "Docente")
                                        ...
                                        <div class="form-group mb-4">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <a href="{{ route('ver-postulaciones-activas-docentes' ) }}" class="btn btn-warning btn-sm btn-block">{{ trans('multi-leng.lognav')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
