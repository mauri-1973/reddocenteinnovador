    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="row justify-content-center mt-4">
                ...
                @if($statusacta == "encurso" || $statusacta == "solicitar" || $statusacta == "sinasesores" || $statusacta == "creada")
                <div class="col-md-12">
                    <div class="card mb-4 bg-success shadow-sm text-white">
                        <div class="card-body">
                            <h3><strong>{{ trans('multi-new.0204')}} </strong></h3><br><br>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingOne" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0100')}}">
                                        <h4 class="panel-title">
                                            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="color:#004238;text-decoration:none;">
                                                <strong>{{ trans('multi-new.0070')}}</strong><i class="nc-icon nc-tap-01" style="font-size:20px;color:#004238">&nbsp;</i> <i class="nc-change nc-icon nc-simple-add float-right" style="font-size:25px;color:#004238;"></i>
                                            </a>
                                        </h4>
                                    </div>
                                </div>
                                <div id="collapseOne" class="panel-collapse collapse mb-3" role="tabpanel" aria-labelledby="headingOne">
                                    <div class="panel-body">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <a role="button" href="{{ route('ver-acta-docente-historial', Crypt::encrypt(1) ) }}" target="_blank" role="button" class="btn btn-primary btn-sm btn-block" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0103') }}">{{ trans('multi-new.0102')}} {{ date('d-m-Y') }}--{{ date('d-m-Y') }}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;color:"></i></a>
                                        </div>                              
                                    </div>
                                </div>
                                    ...
                                    <div class="panel-heading" role="tab" id="headingThree" data-toggle="tooltip" data-placement="top" title="{{ trans('multi-new.0101')}}">
                                        <h4 class="panel-title">
                                            <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" style="color:#004238;text-decoration:none;">
                                                <strong>{{ trans('multi-new.0072')}}</strong><i class="nc-icon nc-tap-01" style="font-size:20px;color:#004238">&nbsp;</i> <i class="nc-change nc-icon nc-simple-add float-right" style="font-size:25px;color:#004238;"></i>
                                            </a>
                                        </h4>
                                    </div>
                ...
                else if( respu.status === "ok" && tipo === "notificaciones" )
                {
                    ...
                    if(respu.html.length > 0)
                    {
                        ...
                        Object.keys(obj).forEach(key => {
                            ...
                            html += `<tr>
                            <td>&nbsp;</td>
                            <td>${obj[key].name} ${obj[key].surname}</td>
                            <td>${obj[key].asunto}</td>
                            <td>${obj[key].mensaje}</td>
                            <td>${text1}</td>
                            <td>${moment(obj[key].fechanot, 'YYYY-MM-DD HH:mm:ss').format('DD-MM-YYYY HH:mm:ss')}</td>
                            <td>${moment(obj[key].fechares, 'YYYY-MM-DD HH:mm:ss').format('DD-MM-YYYY HH:mm:ss')}</td>
                            </tr>`;
                        });
                    }
                    ...
                    $('#modalbody').html(`<div class='col-12 table-responsive'>
                                        <table id="dt-mant-table" class="table table-bordered table-hober display responsive nowrap" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
                                                    <th scope="col">{{ trans('multi-new.0095')}}</th>
                                                    <th scope="col">{{ trans('multi-new.0117')}}</th>
                                                    <th scope="col">{{ trans('multi-new.0035')}}</th>
                                                    <th scope="col">{{ trans('multi-new.0166')}}</th>
                                                    <th scope="col">{{ trans('multi-new.0197')}}</th>
                                                    <th scope="col">{{ trans('multi-new.0198')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            ${html}                                         
