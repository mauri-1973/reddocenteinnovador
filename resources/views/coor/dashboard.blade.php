                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                ...
                                <div class="numbers">
                                    ...
                                    <p class="card-category">{{ __('inst.176') }}</p>

                                    <p class="card-title">{{ $asig }}<p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-7 col-md-8">
                            ...
                            <div class="numbers">
                                ...
                                <p class="card-category">{{ __('inst.178') }}</p>

                                <p class="card-title">{{ $postu }}<p>
        ...
        <div class="col-md-12">
            ...
            <div class="card ">
                ...
                <div class="card-header ">
                    ...
                    <h5 class="card-title">{{ __('inst.176') }}</h5>

                    <p class="card-category">{{ __('inst.179') }}</p>
...
<script type="text/javascript">
...

    {
        ...
        formData.append('tipo', "panelcoorinicio");

        var type = "POST";

        var ajaxurl = "{{route('estadisticas.concursos.asignados.coordinador')}}";
