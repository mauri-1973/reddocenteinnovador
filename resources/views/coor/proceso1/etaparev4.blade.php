                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <hr style="border-top: 3px solid #fff;">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control input-lg textarea1" placeholder="{{ trans('multi-leng.a126')}}" id="preg3et4" name="preg3et4" rows="15" maxlength="1500" disabled>{{ $answ['preg3et4'] }}</textarea>
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                            <a href="{{ route('ver.formulario.coordinador.tercera.etapa', Crypt::encrypt($answ->idansw) ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a104')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
