                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control input-lg textarea1" placeholder="{{ __('multi-leng.a106') }}" id="preg1b" name="preg1b" rows="15" value="" maxlength="1500" readonly>{{ $answ->preg1et3 }}</textarea>
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control input-lg textarea1" placeholder="{{ __('multi-leng.a108') }}" id="preg2b" name="preg2b" rows="15" maxlength="1500" readonly>{{ $answ->preg2et3 }}</textarea>
                                                <span class="help-block">
                                            ...
                                            <div class="form-group mb-4">
                                                ...
                                                <textarea class="form-control input-lg textarea1" placeholder="{{ __('multi-leng.a110') }}" id="preg3b" name="preg3b" rows="15" maxlength="1500" readonly>{{ $answ->preg3et3 }}</textarea>
                                                <span class="help-block">
                                                ...
                                                <div class="container-fluid">
                                                    <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <a href="{{ route('ver.formulario.coordinador.segunda.etapa', Crypt::encrypt($answ->idansw) ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a104')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                            </div>
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                <a href="{{ route('ver.formulario.coordinador.cuarta.etapa', Crypt::encrypt($answ->idansw) ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a88')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                            </div>
                                                    </div>
                                                </div>
                                            </div>
