                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                ...
                                                <input class="form-control input-lg" id="preg1et1" name="preg1et1" type="text" minlength="2" maxlength="70" value="{{ $answ->preg1et1 }}" placeholder="{{ trans('multi-leng.a150')}}" readonly>
                                            </div>
                                            <hr style="border-top: 3px solid #fff;">
                                            <div class="form-group mb-4">
                                                <label for="preg2et1" class="textlabel"><b>{{ trans('multi-leng.a45')}}</b></label>
                                                <textarea class="form-control input-lg textarea1" placeholder="{{ trans('multi-leng.a46')}}" id="preg2et1" name="preg2et1" rows="15" maxlength="500" readonly>{{ $answ->preg2et1 }}</textarea>
                                            ...
                                            <div class="form-group mb-4">
                                                <div class="container-fluid">
                                                    <div class="row">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <a href="{{ route('ver.postulaciones.concurso.coordinador', $idconcurso ) }}" class="btn btn-warning btn-sm btn-block">{{ trans('multi-leng.lognav')}}&nbsp <i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <a href="{{ route('ver.formulario.coordinador.segunda.etapa', Crypt::encrypt($answ->idansw) ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a88')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                            </div>
                                                    </div>
                                                </div>
                                            </div>
