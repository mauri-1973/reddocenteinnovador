    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row justify-content-center mt-4">
                            ...
                            <div class="content">
                                <div class="row">
                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 text-white">
                                        <a href="{{ route('ver-postulaciones-concurso-coordinador', $idconcurso ) }}" class="btn btn-success btn-sm btn-block">{{ trans('lang.volver')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-4 bg-white shadow-sm">
                        <div class="card-body bg-success text-white pt-5 pb-5">
                            <h3>{{ trans('inst.136')}}</h3>
                        </div>
                    </div>
                </div>
            </div>
