                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg1 }}</textarea> 
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs2" name="obs2" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg2 }}</textarea> 
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs3" name="obs3" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg3 }}</textarea> 
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs4" name="obs4" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg4}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs5" name="obs5" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg5 }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <label for="obs6" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs6" name="obs6" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg6 }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <label for="obs7" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs7" name="obs7" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg7 }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <label for="obs8" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs8" name="obs8" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg8 }}</textarea> 
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <label for="obs9" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs9" name="obs9" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg9 }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-4">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                        <a href="{{ route('ver.nuevo.formulario.docente.segunda.etapa.coor', $idpostulacion ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a88')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
