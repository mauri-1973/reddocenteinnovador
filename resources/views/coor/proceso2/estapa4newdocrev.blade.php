                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg20 }}</textarea> 
                                            ...
                                            <br>
                                            <label for="obs1" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg21 }}</textarea> 
                                            ...
                                            <br>
                                            <label for="obs1" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg22 }}</textarea>
                                            ...
                                            <br>
                                            <label for="obs1" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg23 }}</textarea> 
                                        ...
                                        <div class="form-group mb-4">
                                            ...
                                            <br>
                                            <label for="obs1" class="textlabel text-dark"><b>{{ __('inst.74') }}</b></label>
                                            <textarea class="form-control input-lg textarea1 text-dark" placeholder="{{ __('inst.78') }}" id="obs1" name="obs1" rows="15" maxlength="250" disabled>{{ $finalstus->obspreg24 }}</textarea> 
                                        </div>
                                        <hr style="border-top: 2px solid #000;">
                                        <div class="form-group mb-4">
                                            <div class="container-fluid">
                                                <div class="row">
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                        <a href="{{ route('ver.nuevo.formulario.docente.tercera.etapa.coor', $idpostulacion ) }}" class="btn btn-primary btn-sm btn-block">{{ trans('multi-leng.a104')}}&nbsp;<i class="nc-icon nc-tap-01" style="font-size:15px;"></i></a>
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
